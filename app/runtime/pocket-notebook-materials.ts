...
export const POCKET_NOTEBOOK_MATERIALS = [
  {
    id: 'page-one-trauma',
    recipe: 'carried',
    story: 'Most exposed first page: handled edge, grime, tide/stain trauma and a small graphite echo.',
    layers: [
      { id: 'wear-tonal-drift', opacity: 0.62 },
      { id: 'wear-edge-oxidation', opacity: 0.92 },
      { id: 'wear-handling-grime', opacity: 0.95 },
      { id: 'wear-foxing-light', opacity: 0.32 },
      { id: 'wear-humidity-bloom', opacity: 0.18 },
      { id: 'wear-water-stain', opacity: 0.92 },
      { id: 'wear-smudge', opacity: 0.20 },
    ],
  },
  {
