...
/* EXTRACTED VERBATIM from public/shared/paper-stack.js
...
const MODEL_KEYS=['strata','seed','family','familyMix','exposure','fei','notebookEdge',
  ...
  'placementMode'];
const PERF=false;   // lab-only debug timing removed in extraction
...
export const PaperStack = { rnd, hash1, h2, clamp01, lerp, STOCK,
